...
// Generated Jan 7, 2015 1:29:25 PM by Hibernate Tools 3.2.1.GA


import java.util.Date;

/**
 * Selldiesellog generated by hbm2java
 */
public class Selldiesellog  implements java.io.Serializable {
    ...
    public Selldiesellog() {
    }

    public Selldiesellog(String partyLink, String machineName, String machineNumber, String driverName, Double lastQuantity, Double usedQuantity, Double presentQuantity, String personPresentName, Date dateOfAddition, Date timeOfAddition, String location, String addedByPersonName, String addedWithRight, String rawField1, String rawField2, String rawField3, String rawField4, String rawField5, String rawField6) {
